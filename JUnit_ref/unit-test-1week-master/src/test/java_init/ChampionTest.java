...
public class ChampionTest {
    ...
    public void testForRelatedString() {
        ...
        assertThat(sampleString1, allOf(notNullValue(), startsWith("Player")));
        assertThat(sampleString2, containsString("Player point"));
        assertThat(endString, allOf(startsWith("p"), endsWith("t")));
    }
    ...
    //anything 테스트 어떤 값이 올지 정확히 모를때 어떤거이 오든 성공이 되는 것
    @Test
    ...
    public void shouldHasPropertyPosition() {
        ...
        System.out.println("chapion ::" + championList.get(2));
    }
    ...
    public void shouldHaveSamePropertyAndValue() {
        ...
        List<String> championArray = championNames1;
        assertThat(championNames1, samePropertyValuesAs(championNames2));
        assertThat(championArray, samePropertyValuesAs(championNames1));
    }
    ...
    public void shouldTopChampionIsDarius() {
        ...
        System.out.println("chapion :: " + filterChampion);
    }
