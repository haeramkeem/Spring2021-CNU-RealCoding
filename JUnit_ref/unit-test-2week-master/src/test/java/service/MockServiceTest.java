...
public class MockServiceTest {
    ...
    @Test
    public void 어떠한챔피언이름을_입력해도_베인을_리턴한다() {
        Champion champion = mock(Champion.class);
    ...
    @Test
    public  void 어떠한챔피언포지션을_입력해도_미드를_리턴() {
        Champion champion = mock(Champion.class);
    ...
    public void 챔피언이름을_야스오로저장하면_doThrow사용하여_Exception발생한다(){
        Champion champion = mock(Champion.class);
    ...
    public void shouldOneTimeRunForChampionArraySize() {
        ...
        Champion topCamp = mock(Champion.class);
        topCamp.setName("티모");
        topCamp.setPosition("탑");
        topCamp.setHasSkinCount(3);
    ...
    @Test
    public void 리산드라로_검색하면_포지션이_탑이맞는지_확인() {
    ...
    public void 가짜챔피언객체리스트리턴(){
        ...
        when(mockService.findAllChampions()).thenReturn(champions);
        assertThat(mockService.findAllChampions().get(0).getName(), is("조이"));
